...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <p className="text-lg text-muted mb-10 max-w-md leading-relaxed">
        Create lists, track tasks, and stay on top of your day — simple and distraction-free.
      </p>

      <button
        onClick={() => navigate('/todo-lists')}
        className="group px-8 py-3.5 bg-primary text-primary-foreground rounded-full text-base font-semibold cursor-pointer hover:bg-primary-hover transition-all shadow-md hover:shadow-lg flex items-center gap-2"
      >
        Get Started
      ...
      <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl w-full">
        {[
          ...
          <div key={title} className="text-center">
            <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-1">{title}</h3>
